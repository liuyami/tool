...
# Configure
MYSQL_ROOT_PASSWORD="apJNze3VVc9JPNbg"
MYSQL_NORMAL_USER="www"
MYSQL_NORMAL_USER_PASSWORD="z0CxpwYEZEQcVetw"
...
apt-get install -y --force-yes php7.2-cli php7.2 php7.2-dev \
php-redis php-gd php-apcu \
php-curl php-mcrypt php7.2-mysql php7.2-sqlite3 php7.2-mbstring \
php-imap php-mysql php7.2-readline php7.2-xml php7.2-curl php-xdebug \
php-mbstring php-xml php7.2-zip php7.2-intl php7.21-bcmath php-soap php7.2-gd
...
mysql --user="root" --password="${MYSQL_ROOT_PASSWORD}" -e "CREATE USER '${MYSQL_NORMAL_USER}'@'%' IDENTIFIED BY '${MYSQL_NORMAL_USER_PASSWORD}';"
